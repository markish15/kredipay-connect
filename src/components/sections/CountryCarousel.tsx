  ...
  return (
    ...
    >
      ...
      <div className="relative rounded-3xl overflow-hidden aspect-[4/3]">
        ...
        <button
          onClick={prev}
          className="absolute left-3 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-white/20 backdrop-blur-md shadow-lg flex items-center justify-center text-white/80 hover:bg-primary/70 hover:text-white transition-all"
        ...
        <button
          onClick={next}
          className="absolute right-3 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-white/20 backdrop-blur-md shadow-lg flex items-center justify-center text-white/80 hover:bg-primary/70 hover:text-white transition-all"
